...
QT_MOC_LITERAL(1, 13, 12), // "SIG_dealData"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "ISendIp"
QT_MOC_LITERAL(4, 35, 5), // "char*"
QT_MOC_LITERAL(5, 41, 3), // "buf"
QT_MOC_LITERAL(6, 45, 4) // "nLen"

    },
    "INetMediator\0SIG_dealData\0\0ISendIp\0"
    "char*\0buf\0nLen"
};
...
void INetMediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SIG_dealData((*reinterpret_cast< long(*)>(_a[1])),(*reinterpret_cast< char*(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (INetMediator::*_t)(long , char * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&INetMediator::SIG_dealData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void INetMediator::SIG_dealData(long _t1, char * _t2, int _t3)
{
